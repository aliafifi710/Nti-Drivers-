...
void H_LCD_void_Init(void)
{
	...
	//DIO_voidSetPinDirection(LCD_RW_PORT_ID,LCD_E_PIN_ID,OUTPUT);
...
//
//	DIO_voidSetPinValue(LCD_DATA_PORT_ID,LCD_D4_PIN,LOGIC_LOW);
//	DIO_voidSetPinValue(LCD_DATA_PORT_ID,LCD_D5_PIN,LOGIC_HIGH);
//	DIO_voidSetPinValue(LCD_DATA_PORT_ID,LCD_D6_PIN,LOGIC_LOW);
//	DIO_voidSetPinValue(LCD_DATA_PORT_ID,LCD_D7_PIN,LOGIC_LOW);
	_delay_ms(1);
